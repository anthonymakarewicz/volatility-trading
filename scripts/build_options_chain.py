...
Typical usage:
    python scripts/build_options_chain.py --config config/orats_options_chain_build.yml
    python scripts/build_options_chain.py --tickers SPX SPY --years 2019 2020
