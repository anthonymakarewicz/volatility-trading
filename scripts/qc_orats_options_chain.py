...
Typical usage:
    python scripts/qc_orats_options_chain.py --config config/orats_qc_options_chain.yml
    python scripts/qc_orats_options_chain.py --tickers SPX AAPL
...
def main() -> None:
    ...
    dte_bins = _ensure_list(config.get("dte_bins")) or []
    delta_bins = _ensure_list(config.get("delta_bins")) or []
