...
- [API Scope](reference/api_scope.md): explicit public vs internal API boundaries for `0.1.x`.
- [Examples](../examples/README.md): runnable end-to-end and focused hedging examples.
